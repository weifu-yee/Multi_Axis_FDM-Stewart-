...
#define MOTOR_GPIO_PORT_1_1 GPIOE		//L298N
#define MOTOR_GPIO_PIN_1_1 GPIO_PIN_7
#define MOTOR_GPIO_PORT_1_2 GPIOB
#define MOTOR_GPIO_PIN_1_2 GPIO_PIN_7

#define ENCODER_HTIM_2 &htim3
#define MOTOR_HTIM_2      &htim13
#define MOTOR_CHANNEL_2   TIM_CHANNEL_1
#define MOTOR_GPIO_PORT_2_1 GPIOE		//L298N
#define MOTOR_GPIO_PIN_2_1 GPIO_PIN_10
#define MOTOR_GPIO_PORT_2_2 GPIOG
#define MOTOR_GPIO_PIN_2_2 GPIO_PIN_14
